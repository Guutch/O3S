...
class InstagramAccount extends Model {
  static init(sequelize) {
    return super.init({
      ...
      // Remove explicit created_at and updated_at definitions
    }, {
      sequelize, // Pass Sequelize instance
      modelName: 'InstagramAccount', // Set model name
      tableName: 'InstagramAccounts', // Ensure this matches your DB
      timestamps: true,    // Let Sequelize add createdAt/updatedAt automatically
